...
var story = ["The year is 3089.",
 "It has been 107 years since the four crew members of mission Aeternitas 1 left Earth.",
...
"Immediately following the discovery, ASAN assembled a four-person crew to make the journey across space and time to X45t-9 and establish a colony.",
