...
const SpiderDeathEffect = preload("res://Effects/spider_death_effect.tscn")
...
#				chargeController.dashing = false
	...
	if health <= 0:
		...
		spiderDeathEffect.global_position = global_position
		spiderDeathEffect.flip_h = sprite.flip_h
